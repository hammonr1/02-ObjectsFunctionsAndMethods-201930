...
def try_methods_and_functions():
    turdle = rg.SimpleTurtle('turtle')
    turdle.pen = rg.Pen('blue', 5)
    turdle.backward(150)
    turdle.speed = 1
    draw_many_squares(turdle, 10, 50, 15)

    turdle.speed = 100
    turdle.pen = rg.Pen('blue', 35)
    draw_many_squares(turdle, 8, 300, 60)
    turdle.pen = rg.Pen("black", 3)
    turdle.backward(200)
    turdle.draw_circle(30)
    turdle.draw_square(50)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
