...
#    better_draw_circles(rg.Point(100, 0),3)
    even_better_draw_circles(rg.Point(100, 0), 15, 10,"red", 2)
    even_better_draw_circles(rg.Point(300, 0), 6, 11,"magenta", 10)
...
def even_better_draw_circles(point,radius,num,color,thick):
